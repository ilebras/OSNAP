...
legend()
savefig('../notes/salinity_calib/figures/CF4_100_scorr.pdf',bbox_inches='tight')
...
legend()
grid('on')
savefig('../notes/salinity_calib/figures/CF4_350_scorr.pdf',bbox_inches='tight')
...
legend()
ylabel('salinity difference')
savefig('../notes/salinity_calib/figures/CF4_400_scorr.pdf',bbox_inches='tight')
#####################################################################
#####################################################################
#####################################################################
###########                 CF5                    #################
...
legend()
grid('on')
savefig('../notes/salinity_calib/figures/CF6_150_scorr.pdf',bbox_inches='tight')
...
legend()
# grid('on')
savefig('../notes/salinity_calib/figures/CF7_100_scorr.pdf',bbox_inches='tight')
...
for mm in range(1,8):
    ...
    for ii,kk in enumerate(prslist[:-1]):
        figure(figsize=(12,3))
        plot(date[mm][kk],pden_precorr[mm][prslist[ii+1]][:len(pden_precorr[mm][kk])]-pden_precorr[mm][kk])
        axhline(0)
        plot(date[mm][kk],pden[mm][prslist[ii+1]][:len(pden[mm][kk])]-pden[mm][kk])
        title('CF'+str(mm)+': '+str(prslist[ii+1])+'db-'+str(kk)+'db; originally '+str(sum((pden_precorr[mm][prslist[ii+1]][:len(pden_precorr[mm][kk])]-pden_precorr[mm][kk])<0))+' inversions')
        # title('CF'+str(mm)+': '+str(prslist[ii+1])+'db-'+str(kk)+'db; finally '+str(sum((pden[mm][prslist[ii+1]][:len(pden[mm][kk])]-pden[mm][kk])<0))+' inversions')
        ylabel('Density difference (kg m$^{-3}$)')
        savefig('../notes/salinity_calib/figures/CF'+str(mm)+'_'+str(prslist[ii+1])+'db-'+str(kk)+'db.pdf',bbox_inches='tight')
        savefig('../figures/invercheck/perinst/CF'+str(mm)+'_'+str(prslist[ii+1])+'db-'+str(kk)+'db.png',bbox_inches='tight')
...
for mm in range(1,8):
    ...
    ylabel('Salinity')
    legend()
    savefig('../notes/salinity_calib/figures/CF'+str(mm)+'_salbefore.pdf',bbox_inches='tight')
...
for mm in range(1,8):
    ...
    ylabel('Salinity')
    legend()
    savefig('../notes/salinity_calib/figures/CF'+str(mm)+'_salafter.pdf',bbox_inches='tight')
...
for mm in range(1,8):
    ...
    if mm>=6:
        xlim([34,35.2])
    savefig('../notes/salinity_calib/figures/CF'+str(mm)+'_TSafter.pdf',bbox_inches='tight')
...
for mm in range(1,8):
    ...
    if mm>=6:
        xlim([34,35.2])
    savefig('../notes/salinity_calib/figures/CF'+str(mm)+'_TSbefore.pdf',bbox_inches='tight')
...
for ii,dd in enumerate(dlim[:-1]):
    ...
    if dd>=500:
        xlim([34.8,35.1])
    savefig('../notes/salinity_calib/figures/CF4-7_TSafter_'+str(dd)+'-'+str(dlim[ii+1])+'.png',bbox_inches='tight')
    ...
    if dd>=500:
        xlim([34.8,35.1])
    savefig('../notes/salinity_calib/figures/CF4-7_TSbefore'+str(dd)+'-'+str(dlim[ii+1])+'.png',bbox_inches='tight')
...
savefig('../notes/salinity_calib/figures/CF1-4_TSafter.png',bbox_inches='tight')
...
savefig('../notes/salinity_calib/figures/CF1-4_TSbefore.png',bbox_inches='tight')

#####################################################################
#########  Save corrected data in a pickle  #########################
#####################################################################
...
pickle.dump([date,month,prs,salfinal,tmp],
            open('../pickles/TSdailydic/TS_daily_dic_wcorr.pickle','wb'))

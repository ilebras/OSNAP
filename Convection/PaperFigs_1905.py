...
dlist=['2014-10-1','2015-2-15','2015-4-15','2015-10-1','2016-2-1','2016-4-1']
dtitlist=['Oct 1, 2014','Feb 15, 2015','Apr 15, 2015','Oct 1, 2015','Feb 1, 2016','Apr 1, 2016']
...
def ThickEvol():
    ...
    ThickComp_Tseries(4,7,cf5col,m1col,p1,p2,ax1)
    ThickComp_Tseries(7,'ooi',m1col,ooicol,p2,p3,ax2)
    ...
    for ii,d1 in enumerate(dlist):
        ...
        if ii!=0:
            ...
            text(120,500,'uLSW',fontsize=16)
            text(120,1000,'dLSW',fontsize=16)
...
def ThickEvol_wTS():
    ...
    for ii,d1 in enumerate(dlist):
        ...
        if ii!=0:
            ...
            axx.text(34.95,4.55,'uIIW',fontsize=14)
            axx.text(34.95,4.05,'dIIW',fontsize=14)

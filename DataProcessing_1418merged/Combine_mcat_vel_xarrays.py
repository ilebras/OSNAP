...
moornum=1
mcat=xr.open_dataset(datadir+'OSNAP_CFgridded_2014-2018/CF'+str(moornum)+'_mcat_vertgrid_daily.nc')
vel=xr.open_dataset(datadir+'OSNAP_CFgridded_2014-2018/CF'+str(moornum)+'_vel_vertgrid_daily.nc')

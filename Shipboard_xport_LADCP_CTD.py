...
ylim([3e3,0])
xlim([0,300])
savefig('../figures/LADCP/wden/LADCP_uacross_mean_wden.png',bbox_inches='tight')
savefig('../figures/LADCP/wden/LADCP_uacross_mean_wden.pdf',bbox_inches='tight')
...
savefig('../figures/LADCP/wden/LADCP_panels_uacross_wden.png',bbox_inches='tight')
savefig('../figures/LADCP/wden/LADCP_panels_uacross_wden.pdf',bbox_inches='tight')

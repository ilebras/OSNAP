...
xr14=xr.Dataset({'uacross':(['depth','dist'],adcp_14['across track velocity']),'lon':(['dist'],adcp_14['lon'][0]-360),'lat':(['dist'],adcp_14['lat'][0])},coords={'dist':adcp_dist[:-3],'depth':adcp_14['depth'][:,0]})
xr16=xr.Dataset({'uacross':(['depth','dist'],adcp_16['across track velocity']),'lon':(['dist'],adcp_16['lon'][0]-360),'lat':(['dist'],adcp_16['lat'][0])},coords={'dist':adcp_dist,'depth':adcp_16['depth'][:,0]})
...
contadcp(adcp_dist[:-3],adcp_14,'2014')

contadcp(adcp_dist[:],adcp_16,'2016')
